#
# Module manifest for module 'QuickAccess'
#
# Generated by: user1
#
...
AliasesToExport = @(
        'qa', 'qae', 'qaa', 'qax', 'qar', 'qas', 'qap', 'qal', 'qaf', 'qao',
        'qf', 'qfa', 'qfx', 'qfp', 'qfl', 'qfo'
)
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = @('1.0.2: fixes README.md add tutorial')
